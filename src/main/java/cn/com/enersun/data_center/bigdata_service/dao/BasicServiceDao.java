...
public interface BasicServiceDao {
	...
	* @throws
	 */
	List<DmDeviceEntity> queryMainAssetInfoByOrgAndSite(String sql,Map<String, Object> params);
	...
	* @throws
	 */
	List<DmPartEntity> queryPartsInfoByOrgAndSite(String sql,Map<String, Object> params);
	...
	* @throws
	 */
	List<DmDeviceEntity> queryMainAssetInfoByAssetId(String sql,Map<String, Object> params);
	...
	* @throws
	 */
	List<DmPartEntity> queryPartsInfoByPartId(String sql,Map<String, Object> params);
	...
	* @throws
	 */
	List<DmDeviceEntity> queryMainAssetInfoByClassfiyId(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<TowerEntity> queryTowerInfoByOrgcode(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<Dm_TransformerEntity> queryTransformerInfoByParameters(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<Dm_Current_TransformerEntity> queryCurrentTransformerByParameters(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<Dm_Poten_TransformerEntity> queryPotenTransformerByParameters(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<Dm_BreakerEntity> queryBreakerByParameters(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<Dm_Isolator_SwitchEntity> queryIsolatorSwitchByParameters(String sql, Map<String, Object> params);
	...
	* @throws
	 */
	List<Dm_FuseEntity> queryFuseByParameters(String sql, Map<String, Object> params);
